...
import com.tablefootbal.server.controller.GameObserverController;
...
public class GameObserverControllerTest {
    ...
    public void givenRequestToRegister_shouldReturnHTTP_OK(){
        ...
        GameObserverDto goDto = new GameObserverDto("token1234124121412", new String[]{"123445","12315555"});
